...
locals {
    github-repo = "https://github.com/merthuseyin/project-204-phonebook.git"
    github-file-url = "https://raw.githubusercontent.com/merthuseyin/project-204-phonebook/master/"
}
...
resource "aws_ecr_repository" "ecr-repo" {
    name                 = "mert-clarusway-repo/phonebook-app"
